...
public class DogDB {
    ...
    static final String DB_CONNECTION_URL = "jdbc:mysql://localhost:3306/dog";     //Connection string – where's the database?
    static final String USER = "Anthony";   //TODO replace with your username
    static final String PASSWORD = "Alpha5555Beta!";   //TODO replace with your password
